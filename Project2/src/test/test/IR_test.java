...
import static vote.IR.delete_invalid_ballots;
...
public class IR_test {
  ...
  /**
   * Test for deleting invalid ballot
   *
   * @throws IOException throw for invalid data
   */
  @Test
  public void test_delete_invalid_ballot() throws IOException {
    File f = generate_file.create("test_delete_invalid_ballot");
    //when number of candidates is odd
    String[] ballot1 = new String[7];
    ballot1[0] = "1,3,2";
    ballot1[1] = "1,,2";
    ballot1[2] = "1,2,3";
    ballot1[3] = "3,2,1";
    ...
    ballot1[5] = ",,1";
    ballot1[6] = "2,1,";
    String[] candidate1 = new String[3];
    candidate1[0] = "Rose";
    candidate1[1] = "Kleinberg";
    candidate1[2] = "Chou";
    ballot1 = delete_invalid_ballots(candidate1, ballot1, f);
    assertEquals(6, ballot1.length);
    //when number of candidates is even
    String[] ballot2 = new String[7];
    ballot2[0] = "1,3,4,2";
    ballot2[1] = "1,,,";
    ballot2[2] = "1,2,3,";
    ballot2[3] = "3,2,1,4";
    ...
    ballot2[5] = ",,,1";
    ballot2[6] = "2,1,,3";
    String[] candidate2 = new String[4];
    candidate2[0] = "Rose";
    candidate2[1] = "Kleinberg";
    candidate2[2] = "Chou";
    candidate2[3] = "Royce";
    ballot2 = delete_invalid_ballots(candidate2, ballot2, f);
    assertEquals(5, ballot2.length);
  }
